...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT *
              ...
              WHERE student_email LIKE '$student_email%'";
        ...
        <div class="content w-full">
            ...
            <div class="head bg-white p-15 between-flex">
                <div class="search p-relative">
                    <form method="post">
                        <label for="student_email">Search Student Email</label>
                        <input class="p-10" type="search" placeholder="Search Student Name" name="student_email" id="student_email">
