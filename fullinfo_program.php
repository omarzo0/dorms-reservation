...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT *
              ...
              WHERE student_program LIKE '$student_program%'";
        ...
        <div class="content w-full">
            <div class="head bg-white p-15 between-flex">
                <div class="search p-relative">
                    <form method="post">        
                        <label for="search"><h2>Search By Program</h2></label> <br>
                        <input type="text" id = "search" name="student_program" placeholder="Enter Program">
